...
struct upnp_device_descriptor render_device= {upnp_renderer_init,"urn:schemas-upnp-org:device:MediaRenderer:1","CastReceiver","K.D.Hedger","https://github.com/KeithDHedger/CastReceiver",PACKAGE_STRING,PACKAGE_NAME,PACKAGE_VERSION,"https://github.com/KeithDHedger/CastReceiver","1","uuid:CastReceiver-1_0-000-000-002","","",NULL,NULL};
