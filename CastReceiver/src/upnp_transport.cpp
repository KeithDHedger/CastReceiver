...
struct var_meta transport_var_meta[] =
{
	...
	[TRANSPORT_VAR_NEXT_AV_URI_META]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_TRACK_META]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_REL_CTR_POS]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_AAT_INSTANCE_ID]={ SENDEVENT_NO,DATATYPE_UI4,NULL,NULL },
	
	[TRANSPORT_VAR_AAT_SEEK_TARGET]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_PLAY_MEDIUM]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},

	//[TRANSPORT_VAR_REL_TIME_POS]={SENDEVENT_NO,DATATYPE_STRING,(const char**)kZeroTime,NULL},/*TODO*/
[TRANSPORT_VAR_REL_TIME_POS]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},


	[TRANSPORT_VAR_REC_MEDIA]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_PLAY_MODE]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_TRANSPORT_PLAY_SPEED]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_PLAY_MEDIA]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_ABS_TIME_POS]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_TRACK]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_TRACK_URI]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_TRANSPORT_ACTIONS]={ SENDEVENT_NO,DATATYPE_STRING,NULL,NULL },

	[TRANSPORT_VAR_NR_TRACKS]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_AV_URI]={ SENDEVENT_NO,DATATYPE_STRING,NULL,NULL },
	
	[TRANSPORT_VAR_ABS_CTR_POS]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_REC_QUAL_MODE]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_CUR_MEDIA_DUR]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_AAT_SEEK_MODE]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_AV_URI_META]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_REC_MEDIUM]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_REC_MEDIUM_WR_STATUS]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	[TRANSPORT_VAR_LAST_CHANGE]={ SENDEVENT_YES,DATATYPE_STRING,NULL,NULL },
//	[TRANSPORT_VAR_CUR_TRACK_DUR]={SENDEVENT_NO,DATATYPE_STRING,(const char**)kZeroTime,NULL},/*TODO*/
	[TRANSPORT_VAR_CUR_TRACK_DUR]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
	
	[TRANSPORT_VAR_TRANSPORT_STATE]={ SENDEVENT_NO,DATATYPE_STRING,transport_states,NULL },
	[TRANSPORT_VAR_POS_REC_QUAL_MODE]={SENDEVENT_NO,DATATYPE_UNKNOWN,NULL,},
...
struct argument arg1={ "InstanceID",PARAM_DIR_IN,TRANSPORT_VAR_AAT_INSTANCE_ID };
...
struct argument *arguments_setavtransporturi[] = {&arg1,&arg2,&arg3,NULL};
/*
{
...
struct argument *arguments_getdevicecapabilities[] ={&arg4,&arg5,&arg6,&arg7,NULL};
/*
{
	& (struct argument) { "InstanceID",PARAM_DIR_IN,TRANSPORT_VAR_AAT_INSTANCE_ID },
...
struct argument *arguments_gettransportsettings[] ={&arg8,&arg9,&arg10,NULL};
/*
{
	& (struct argument) { "InstanceID",PARAM_DIR_IN,TRANSPORT_VAR_AAT_INSTANCE_ID },
...
struct argument *arguments_stop[] ={&arg11,NULL};
/*
{
	& (struct argument) { "InstanceID",PARAM_DIR_IN,TRANSPORT_VAR_AAT_INSTANCE_ID },
	NULL
...
struct argument *arguments_play[] ={&arg12,&arg13,NULL};
//{
//	& (struct argument) { "InstanceID",PARAM_DIR_IN,TRANSPORT_VAR_AAT_INSTANCE_ID },
...
struct argument *arguments_getcurrenttransportactions[] ={&arg14,&arg15,NULL};
//{
//	& (struct argument) { "InstanceID",PARAM_DIR_IN,TRANSPORT_VAR_AAT_INSTANCE_ID },
